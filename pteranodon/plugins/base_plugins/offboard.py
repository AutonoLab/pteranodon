...
class Offboard(AbstractBasePlugin):
    ...
    def set_acceleration_ned(self, accel_ned: offboard.AccelerationNed) -> None:
        ...
        :return: None
        """
        super().submit_coroutine(self._system.offboard.set_acceleration_ned(accel_ned))
    ...
    def set_actuator_control(self, act_ctrl: offboard.ActuatorControl) -> None:
        ...
        :return: None
        """
        super().submit_coroutine(self._system.offboard.set_actuator_control(act_ctrl))
    ...
    def set_attitude(self, attitude: offboard.Attitude) -> None:
        ...
        :return: None
        """
        super().submit_coroutine(self._system.offboard.set_attitude(attitude))
    ...
    def set_attitude_rate(self, attitude_rate: offboard.AttitudeRate) -> None:
        ...
        :return: None
        """
        super().submit_coroutine(self._system.offboard.set_attitude_rate(attitude_rate))
    ...
    def set_position_global(self, pos_global: offboard.PositionGlobalYaw) -> None:
        ...
        :return: None
        """
        super().submit_coroutine(self._system.offboard.set_position_global(pos_global))
    ...
    def set_position_ned(self, pos_ned: offboard.PositionNedYaw) -> None:
        ...
        :return: None
        """
        super().submit_coroutine(self._system.offboard.set_position_ned(pos_ned))
