...
class Camera(AbstractBasePlugin):
    ...
    def __init__(self, system: System, loop: AbstractEventLoop, logger: Logger) -> None:
        ...
        super().submit_coroutine(self._update_current_settings())
        super().submit_coroutine(self._update_possible_setting_opts())
    ...
    def prepare(self) -> None:
        ...
        super().submit_coroutine(self._system.camera.prepare())
    ...
    def format_storage(self) -> None:
        ...
        super().submit_coroutine(self._system.camera.format_storage())
    ...
    def start_photo_interval(self, interval_s: float) -> None:
        ...
        """
        super().submit_coroutine(self._system.camera.start_photo_interval(interval_s))
    ...
    def stop_photo_interval(self) -> None:
        ...
        """
        super().submit_coroutine(self._system.camera.stop_photo_interval())
        if self._status is not None:
    ...
    def start_video(self) -> None:
        ...
        """
        super().submit_coroutine(self._system.camera.start_video())
        if self._status is not None:
    ...
    def stop_video(self) -> None:
        ...
        """
        super().submit_coroutine(self._system.camera.stop_video())
        if self._status is not None:
    ...
    def start_video_streaming(self) -> None:
        ...
        """
        super().submit_coroutine(self._system.camera.start_video_streaming())

    def stop_video_streaming(self) -> None:
        """
        Stop current video streaming
        """
        super().submit_coroutine(self._system.camera.stop_video_streaming())

    def take_photo(self) -> None:
        """
        Take one photo
        """
        super().submit_coroutine(self._system.camera.take_photo())
    ...
    def select_camera(self, camera_id: int) -> None:
        ...
        """
        super().submit_coroutine(self._system.camera.select_camera(camera_id))
    ...
    def set_mode(self, mode: camera.Mode) -> None:
        ...
        """
        super().submit_coroutine(self._system.camera.set_mode(mode))
        self._mode = mode
    ...
    def set_setting(
        ...
        super().submit_coroutine(self._system.camera.set_setting(setting_obj))
    ...
    def list_photos(self, photos_range: camera.PhotosRange) -> List[camera.CaptureInfo]:
        ...
        list_photos_task = super().submit_coroutine(
            self._system.camera.list_photos(photos_range)
        )
